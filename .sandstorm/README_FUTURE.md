...
How is notification arrival time, compared to let's say ntfy.sh (with Instant Delivery)? Curious if it's more often instant on ntfy.sh, or if the few-seconds pause happens there as well.
