...
- [x] Think about upgrades - this is more vulnerable than most Sandstorm apps.
    ...
    * Maybe tell them to stop using it if they don't hear from me.
    - [x] Upgrade to latest tag (v2.13.0 is now out)
...
- [x] Don't use of `forSharing`
    * The main reason for this: I don't want the API keys to end up in the sharing menu instead of web key menu.
...
- [x] How is Android handling ntfy for Sandstorm?
    [x] How is battery life according to the OS?
        [x] Check on the Internet to see what expected battery usage is. Put into Validation phase.
            Answer: It seems to match so I'll check this off, but in validation phase I'll do a more long check.
