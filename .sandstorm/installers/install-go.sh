...
go version | grep 'go version go1.24.4 linux/amd64' && exit 0

# https://golang.org/doc/install
wget https://golang.org/dl/go1.24.4.linux-amd64.tar.gz -O /tmp/golang.3e9a2640b23f279fabc6c5ed40d101f1.tar.gz
